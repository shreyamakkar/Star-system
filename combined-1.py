...
#Although radius has been calculated in the props function, it may not work well for all stars
    ...
    def makeMainSequenceStar(self):
        ...
        ems.inputs[1].default_value=100
        ...
        ems2.inputs[1].default_value=50
    ...
    def makeBlueGiant(self):
        ...
        if self.M < 10*M0:
            ...
            emission.inputs[1].default_value = 980
    ...
    def makeProtoStar(self):
        ...
        emission.inputs[1].default_value = 40
    ...
    def makeRedGiant(self):
        ...
        if self.M < 10*M0:
            r_emission.inputs[1].default_value = 900
        else:
            r_emission.inputs[1].default_value = 1000
